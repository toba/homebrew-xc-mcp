class XcMcp < Formula
  ...
  url "https://github.com/toba/xc-mcp/releases/download/v0.4.1/xc-mcp-v0.4.1-arm64.tar.gz"
  version "0.4.1"
  sha256 "524c67523b90e5511e1fad24c91d9bcbdcc29d3192d0a676365e7060fb6a2b5f"
  license "MIT"
